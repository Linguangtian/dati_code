<?php
/**
 * [9号授权系统 System] Copyright (c) 2018 33f3.CN
 * 9号授权系统 is NOT a free software, it under the license terms, visited https://www.9hym.com/ for more details.
 */
...
if ($do == 'upgrade') {
    ...
    if (empty($_W['setting']['cloudip']) || $_W['setting']['cloudip']['expire'] < TIMESTAMP) {
        $cloudip = gethostbyname('sq.9hym.com');
