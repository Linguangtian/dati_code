		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="https://www.9hym.com">9号官网</a></li>
					<li role="presentation"><a href="https://www.9hym.com">9号论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="https://www.9hym.com">关于9号</a> &nbsp; &nbsp; <a href="https://www.9hym.com">9号社区</a> &nbsp; &nbsp; <a href="http://www.9hym.com">无需授权</a>
				</div>
				<div class="text-center">
					Powered by <a href="https://www.9hym.com"><b>9号源码社区</b></a>  &copy; 2018 <a href="https://www.9hym.com">www.9hym.com</a>
				</div>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=cf56757e4a4928d237505885fba65c1c3a02798a8f26ff2be39bf7c5c81a469d"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="9号源码社区交流群" title="9号源码社区交流群"></a>
						</label>
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“9号微擎”系统，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
