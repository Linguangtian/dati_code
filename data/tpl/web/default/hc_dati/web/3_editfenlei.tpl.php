    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="" name="submit">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control"  name="name" value="<?php  echo $fenlei['name'];?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control"  name="sort" style="width: 100px;" value="<?php  echo $fenlei['sort'];?>">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<?php  echo tpl_form_field_image('bg_img',$fenlei['bg_img']);?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<?php  echo tpl_form_field_image('img',$fenlei['img']);?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<?php  echo tpl_form_field_image('img1',$fenlei['img1']);?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<?php  echo tpl_form_field_image('img2',$fenlei['img2']);?>
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<?php  echo tpl_form_field_image('img3',$fenlei['img3']);?>
...
<script>
    document.getElementById("cate")[<?php  echo $fenlei['status'];?>].selected=true;
</script>
