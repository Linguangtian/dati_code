...
<ul class="nav nav-tabs" id="snav">
    ...
    <li class="active"><a href="<?php  echo url('site/entry/Pxhexiao',array('m'=>'hc_dati'));?>">排行榜核销</a></li>
</ul>
       ...
       <div class="alert alert-info url_div hide" role="alert">
            ...
            <div class="table-responsive panel-body">
                <table class="table table-hover">
                    ...
                    <tbody id="level-list">
                    <?php  if(is_array($pxxiangqing)) { foreach($pxxiangqing as $item) { ?>
                     <tr>
                         ...
                         <td><div class="type-parent" style="text-align: center;"><?php  echo $item['lingjiang_status'];?></div></td>
                         ...
                         <td style="text-align:right;">
                             <a class="btn btn-default btn-sm" href="<?php  echo url('site/entry/Editpxhexiao',array('id'=>$item['id'],'m'=>'hc_dati'));?>" title="编辑">核销</a>&nbsp
                             <a class="btn btn-default btn-sm" href="<?php  echo url('site/entry/Deletepxhexiao',array('id'=>$item['id'],'m'=>'hc_dati'));?>" onclick="return confirm('确认删除此奖品吗？');return false;" title="删除">删</a>
                         </td>
                    </tr>
                    <?php  } } ?>     
                    </tbody>
