    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="" name="submit">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					 <select class="form-control" id="status" name="status" style="width: 50%;" value="<?php  echo $jiangpin['status'];?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" id="hexiao_status" name="hexiao_status" style="width: 50%;" value="<?php  echo $jiangpin['hexiao_status'];?>">
			...
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">奖项名称</label>
				<div class="col-sm-10">
					<input type="text" class="form-control"  name="ranking_name" style="width: 100px;" value="<?php  echo $jiangpin['ranking_name'];?>">
				</div>
			</div>
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">奖项配置</label>
				<div class="col-sm-10">
					<input type="text" class="form-control"  name="ranking_sort" style="width: 100px;" value="<?php  echo $jiangpin['ranking_sort'];?>">
					<div class="clo-sm-3">
						（例：一等奖这里填‘1’）
					</div>
				</div>
			...
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">奖品数量</label>
				<div class="col-sm-10">
					<input type="text" class="form-control"  name="num" style="width: 100px;" value="<?php  echo $jiangpin['num'];?>">
				</div>
			</div>
...
<script>
    document.getElementById("status")[<?php  echo $jiangpin['status'];?>].selected=true;
    document.getElementById("hexiao_status")[<?php  echo $jiangpin['hexiao_status'];?>].selected=true;
</script>
