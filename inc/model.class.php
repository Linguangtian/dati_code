...
class HcfkModel
{
	...
	*/
	function alert_success($msg='',$url,$time=3){ 
		$str='<script type="text/javascript" src="../addons/hc_zhili/template/web/js/jquery-1.8.2.min.js"></script> <script type="text/javascript" src="../addons/hc_zhili/template/web/js/layer/layer.js"></script>';//加载jquery和layer
		$str.='<script>
		$(function(){
